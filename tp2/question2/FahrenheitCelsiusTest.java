...
public class FahrenheitCelsiusTest extends junit.framework.TestCase
{
     ...
     */
      public void test_fahrenheitEnCelsius() {
        ...
        assertEquals("   250 °F -> 121.1 °C ?", 121.1, question2.FahrenheitCelsius.fahrenheitEnCelsius(250), 0.1);
        assertEquals("   212 °F -> 100 °C ?", 100, question2.FahrenheitCelsius.fahrenheitEnCelsius(212), 0.1);
